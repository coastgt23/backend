...
{
    if (user.OtherData.Avatar == null)
    {
        Console.WriteLine("Avatar was null!");

        return new AvatarDTO
        {
            OutfitSelections = "",
            FaceFeatures = "",
            SkinColor = "5864d23d-1a86-40a6-a52c-46ee670e4508",
            HairColor = "5864d23d-1a86-40a6-a52c-46ee670e4508"
        };
    }

    Console.WriteLine(System.Text.Json.JsonSerializer.Serialize(user.OtherData.Avatar));
